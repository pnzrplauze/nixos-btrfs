...
myFont :: String
myFont = "xft:JetBrainsMono Nerd Font Mono:regular:size=8:antialias=true:hinting=true"
...
myStartupHook = do
    ...
    -- spawnOnce "trayer --edge top --mointor 1 --widthtype pixel --width 40 --heighttype pixel --height 18 --align right --transparent true --alpha 0 --tint 0x292d3e --iconspacing 3 --distance 1 &"
    ...
    spawnOnce "feh --bg-fill --no-fehbg /home/jack/pix/wallpapers/trees.jpg"  -- set last saved feh wallpaper
...
myKeys =
    ...
    -- launch dmenu_run, so I've decided to use M-p plus KEY for these dmenu scripts.
        , ("M-p i", spawn "networkmanager_dmenu -fn 'monospace'")    -- choose an ambient background
...
main = do
    ...
    xmobarLaptop <- spawnPipe "xmobar -x 0 /home/jack/.config/xmobar/primary.hs"
    ...
    xmonad $ ewmh def
        ...
        , logHook = dynamicLogWithPP $ namedScratchpadFilterOutWorkspacePP $ xmobarPP
              ...
              { ppOutput = \x -> hPutStrLn xmobarLaptop x                          -- xmobar on monitor 1
